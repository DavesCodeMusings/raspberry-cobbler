...
## Next steps
Now that we have multiple ways to access the system, it might be nice to have a way to track what's going on. For that we can use syslog logging, and that's the next phase of the project.
