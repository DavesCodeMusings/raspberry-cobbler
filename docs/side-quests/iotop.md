...
If all goes well, it'll look like the example shown below.
...
> If instead you get a message that says: _Error opening terminal: vt102_, see the [tmux side quest instructions for installing the terminfo database](https://github.com/DavesCodeMusings/raspberry-cobbler/blob/main/docs/tmux-side-quest.md#installing-terminfo-data)
